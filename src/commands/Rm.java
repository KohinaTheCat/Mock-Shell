...
/**
 * Class Name: Rm This class holds methods to remove directories
 */
public class Rm implements CommandInterface {
  ...
  /**
   * Checks if the path in arg[1] is a valid path. Sends error to stfError if
   * arg[1] is not a valid path, or returns output of the command.
   * 
   * @param arg Array of arguments
   * @return String Output of the Rm command for stdOut
   */
